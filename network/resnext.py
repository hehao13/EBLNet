...
__all__ = ['ResNet', 'resnext101_32x8']
...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.bn1 = mynn.Norm2d(self.inplanes)
        self.relu = nn.ReLU(inplace=True)
...
def resnext101_32x8(**kwargs):
    ...
    model.load_state_dict(torch.load("./pretrained_models/resnext101_32x8.pth", map_location='cpu'))
    return model
